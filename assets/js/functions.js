...
$('#my-form').submit(function(e) {
	...
	//AJAX request
	$.ajax({
	  url: 'https://docs.google.com/forms/u/0/d/e/1FAIpQLSebt1bd_JI65w2SDU1rHnPM9l0x-Dlq1BNdID2obxOJ7S_aGQ/formResponse',     //The public Google Form url, but replace /view with /formResponse
	  ...
	  statusCode: { //the status code from the POST request
		0: function(data) { //0 is when Google gives a CORS error, don't worry it went through
		  //success
		  $('#form-success').text('Thanks for contacting, we will revert soon.');
		}, 
